...
from models.FCN_classifier import TextFCN
...
def main():
    ...
    ag_news = Dataset()
    model = TextFCN(word_embeddings=ag_news.pretrained_embeds,
    ...
    def generate_batch(data_batch):
        ...
        for (l_item, t_item) in data_batch:
            ...
            text_batch.append(torch.tensor(t_item, dtype=torch.int64))
